...
namespace pmesp.Infrastructure.Migrations
{
    ...
    [Migration("20240109004802_tableChildsAndChildBandit")]
    partial class tableChildsAndChildBandit
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("pmesp.Domain.Entities.Childs.Child", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("pmesp.Domain.Entities.ChildsBandits.ChildBandit", b =>
                {
                    ...
                    b.HasKey("ChildId", "BanditsId");

                    b.ToTable("ChildBandit");
                });
            ...
            modelBuilder.Entity("pmesp.Domain.Entities.ChildsBandits.ChildBandit", b =>
                {
                    ...
                    b.HasOne("pmesp.Domain.Entities.Childs.Child", "Child")
                        .WithMany("Bandits")
                        .HasForeignKey("ChildId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
